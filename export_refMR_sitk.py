...
#I manually edited the metadata of the MR dicoms such that the refMR images are labelled with the following IDs.
refMR_id_list = ['201', '202', '203', '204', '205', '206', '207', '208', '209', '210', '211', '212', '213', '214']
...
for dose_dicom in dose_dicoms:
    ...
    try:
        ...
        db_id = ref_ct_study[0].StudyDescription
        print(db_id)
        id_arr = key()[:,1]
        ...
        # Now save!
        output_directory = os.path.join(pat_directory, "nifti_dump2")
